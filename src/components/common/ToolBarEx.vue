<template>
  ...
  <div style="height: 18px;"></div>
    ...
    <div style="height: 32px;">
      <a-input v-model:value="formState.value" :maxlength="16" :default-value="''" placeholder="请输入用户名称" @pressEnter="submitFn" class="input">
        <!-- 下拉 -->
        <template #addonBefore>
          <a-select v-if="selectOptions.length > 1" class="select w90" v-model:value="formState.selectType">
