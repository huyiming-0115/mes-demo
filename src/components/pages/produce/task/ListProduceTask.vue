      ...
      >
        ...
        <template #bodyCell="{ record, column, index }">
          ...
          <div v-if="column.key === 'operate'" class="flex-start">
            ...
            <a-popconfirm title="确定暂停这条数据吗?" @confirm="">
              <template #default>
                <div class="btn-link ml24">暂停任务</div>
              </template>
            </a-popconfirm>
            <a-popconfirm title="确定完成该条任务嘛?" @confirm="">
              <template #default>
                <div class="btn-link ml24">完成任务</div>
              </template>
            </a-popconfirm>
            <a-popconfirm title="确定对该条任务进行异常申报?" @confirm="">
              <template #default>
                <div class="btn-link ml24">异常申报</div>
              </template>
            </a-popconfirm>
          </div>
        </template>
