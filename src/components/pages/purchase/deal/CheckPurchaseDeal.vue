<template>
  ...
  <div style="padding-left: 5px;">
    ...
    >
      <!-- 权限组类型 -->
      <a-form-item class="form-item-require" label="项目名称" name="selectValue">
        <span>项目名称</span>
      </a-form-item>
      <!-- 权限组说明 -->
      <a-form-item label="意见" name="explain">
        <a-textarea v-model:value="formState.explain" placeholder="请输入意见" :maxlength="1000" showCount :auto-size="{ minRows: 4, maxRows: 4 }" />
      </a-form-item>
    </a-form>
