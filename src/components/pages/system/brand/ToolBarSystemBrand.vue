  ...
  <div class="search">
    <div class="toolbar-position">
      ...
      <div class="toolbar-right">
        <AButton type="primary" class="w100 h35 button-position" @click="dialog.show = true">新增品牌</AButton>
      </div>
    </div>
  </div>
  <MDialog :dialog="dialog">
    <DetailSystemBrand @close="dialog.show = false" :pid="dialog.flag"></DetailSystemBrand>
  </MDialog>
</template>
