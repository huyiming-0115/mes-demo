  ...
  <div class="search">
    <div class="toolbar-position">
      ...
      <div class="toolbar-right">
        <AButton type="primary" class="w100 h35 button-position" @click="dialog.show = true">新增权限组</AButton>
      </div>
    </div>
  </div>

  <MDialog :dialog="dialog">
    <DetailSystemPower @close="dialog.show = false" :pid="dialog.flag"></DetailSystemPower>
  </MDialog>
</template>
