  ...
  <div>
    <div style="height: 300px; overflow-y: auto;">
      ...
      <a-spin :spinning="spinning">
        ...
        >
          ...
          <template #bodyCell="{ record, column, index, text }">
            ...
            <div v-if="column.key === 'operate'" class="flex-start">
              <div class="btn-link">下载附件</div>
              <a-popconfirm title="确定删除该土建文件嘛?" :getPopupContainer="(triggerNode): any => triggerNode.parentNode" @confirm="removeFn(record)">
                <template #default>
                  <div class="btn-link ml24">删除附件</div>
                </template>
              </a-popconfirm>
            </div>
        ...
        <a-button style="float: right;" v-throttle class="w100 h35 primary-button" type="primary">自动生成</a-button>
        <a-button style="float: right; margin-right: 20px;" v-throttle class="w100 h35 primary-button" type="primary">手动上传</a-button>
      </a-spin>
      <!-- 添加部门弹窗 -->
    ...
    <div class="flex-center mt48">
      ...
      <a-button v-throttle class="w100 h35 primary-button" type="primary" @click="closeFn">确定</a-button>
    </div>
  </div>
</template>
