<template>
  <div style="padding-left: 5px;">
    <div style="width: 100%; height: 35px; margin-bottom: 20px;">
      <a-button style="float: right;" v-throttle class="w100 h35 primary-button" type="primary" @click="closeFn">新增产品</a-button>
      <a-button style="float: right; margin-right: 20px;" v-throttle class="w100 h35 primary-button" type="primary" @click="closeFn">导入</a-button>
    </div>
    <!-- 关联部门弹窗 -->
        ...
        >
          ...
          <template #bodyCell="{ record, column, index, text }">
            ...
            <div v-if="column.key === 'operate'" class="flex-start">
              <a-popconfirm title="确定删除该行产品嘛?" :getPopupContainer="(triggerNode): any => triggerNode.parentNode" @confirm="removeFn(record)">
                <template #default>
